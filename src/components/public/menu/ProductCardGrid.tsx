/**
 * Card vertical para produtos no cardápio (card_layout = 'grid').
 * Layout: imagem em destaque no topo, nome, descrição e preço abaixo.
 * Ideal para pratos.
 */
...
function ProductCardGrid({ product, onClick, readOnly = false, currency = 'BRL', convertForDisplay, comboItems, offer }: ProductCardGridProps) {
  ...
  return (
    <div
      ...
      className={`group flex flex-col rounded-2xl overflow-hidden transition-all duration-200 w-full ${
        isOffer
