-- =============================================================================
-- Migration: order_items — adiciona customer_name para divisão de conta por pessoa
-- Usado em pedidos de mesa: agrupa itens por cliente (João, Maria, Mesa Geral)
-- =============================================================================

ALTER TABLE public.order_items
  ADD COLUMN IF NOT EXISTS customer_name text;

COMMENT ON COLUMN public.order_items.customer_name IS 'Nome do cliente na mesa (para divisão de conta). NULL = Mesa Geral.';

-- Atualiza place_order para aceitar e gravar customer_name por item
...
BEGIN
  ...
  -- Incrementar use_count do cupom se aplicado
