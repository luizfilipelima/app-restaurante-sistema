-- =============================================================================
-- Migration: order_items — adiciona coluna addons para adicionais do produto
-- Atualiza place_order para gravar addons nos itens (para cozinha/tela de pedidos)
-- =============================================================================

ALTER TABLE public.order_items
  ADD COLUMN IF NOT EXISTS addons jsonb;

COMMENT ON COLUMN public.order_items.addons IS 'Adicionais do produto: [{addonItemId, name, price}]';

-- =============================================================================
-- Atualiza place_order para incluir addons em order_items
-- =============================================================================
