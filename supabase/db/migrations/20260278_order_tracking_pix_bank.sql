-- =============================================================================
-- Migration: Inclui pix_key e bank_account no get_order_tracking
-- Para que a tela de acompanhamento do pedido mostre os dados de pagamento
-- quando o cliente escolheu PIX ou transferência bancária.
-- =============================================================================
...
BEGIN
  ...
  -- Busca o restaurante (inclui pix_key e bank_account para exibir no tracking)
  SELECT
    r.id,
    r.name,
    r.slug,
