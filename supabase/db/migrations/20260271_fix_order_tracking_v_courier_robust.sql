...
-- Quando courier_id existe mas o entregador foi deletado ou não existe,
-- SELECT INTO v_courier não retorna linhas e v_courier fica não-atribuído.
-- Acesso a v_courier no CASE causa o erro. Solução: variável booleana.
-- Também trata v_restaurant NOT FOUND para robustez.
-- =============================================================================
